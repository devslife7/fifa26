      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        {champion && (
          <div className="bg-white rounded-2xl border border-primary/20 p-6 text-center mb-6 shadow-sm">
            <p className="text-slate-400 text-xs uppercase tracking-widest mb-2">Predicted Champion</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white rounded-xl p-4 text-center border border-slate-100">
            ...
            <div className="text-xs text-slate-400">Group Predictions</div>
          </div>
          <div className="bg-white rounded-xl p-4 text-center border border-slate-100">
            <div className="text-2xl font-black text-primary">{knockoutCount}</div>
            <div className="text-xs text-slate-400">Knockout Predictions</div>
          </div>
        </div>
