      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className={`text-[11px] flex items-center gap-1.5 ${d ? 'text-white/40' : 'text-neutral-400'}`}>
              ...
              {!predictionId && <><span>·</span><span className="text-wc-amber font-medium">unsaved</span></>}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-primary text-black font-bold text-xs hover:bg-primary/90 disabled:opacity-50 transition-colors"
          >
