// DO NOT EDIT — generated by scripts/annexC/extract.ts
// Source: FIFA World Cup 26 Regulations, Annexe C (pp. 80-97).
// Each entry maps an unordered set of 8 group letters (the third-placed teams that qualified)
// to the assignment of those teams to the 8 "Winner vs Best-3rd" R32 matches.
// Key: sorted concatenation of the 8 group letters. Value: { winnerGroup: thirdPlaceGroup }.
...
export const ANNEX_C: Readonly<Record<string, AnnexCAssignment>> = {
